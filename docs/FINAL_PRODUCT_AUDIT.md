...
- 七条产品路由均使用 production build 与固定演示数据完成验证。
- 页面截图来自真实前端状态，并由对应 API、组件测试和 E2E 交互支持。
- 桌面安装包通过隔离安装、启动、健康检查、项目创建、关闭和同数据重启烟测。
...
导览中的页面使用仓库现有产品路由、API、Schema、状态模型和服务。截图与测试证据描述同一套可运行实现，没有另建演示专用工作台。
